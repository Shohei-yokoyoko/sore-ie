...
## 比較不足が気になる場合は、一度立ち止まる

すでに複数社を比較し、契約内容にも納得できている場合は、無理に住宅会社探しへ戻る必要はありません。

一方で、まだ1社しか見ていない、比較候補が不足している、契約直前になって不安が大きくなったという場合は、一度ほかの会社や提案も確認してから判断する方法があります。

**→ 比較候補を増やしてから判断したい：[注文住宅の資料請求・相談サービスを比較｜自分に合う選び方を解説](/articles/custom-home-request-service-comparison)**
